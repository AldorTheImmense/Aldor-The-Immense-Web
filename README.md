...
Most data is stored locally in the user's browser. Save codes can be copied and loaded elsewhere when a DM wants to move shop, custom item, and faction state between devices.
